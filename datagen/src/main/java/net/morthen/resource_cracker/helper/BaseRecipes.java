...
public abstract class BaseRecipes extends RecipeProvider {
    ...
    public void smeltingRecipe(ItemLike result, ItemLike input) {
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(input), RecipeCategory.MISC, CookingBookCategory.MISC, result,
    ...
    public void blastingRecipe(ItemLike result, ItemLike input) {
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(input), RecipeCategory.MISC, CookingBookCategory.MISC, result,
