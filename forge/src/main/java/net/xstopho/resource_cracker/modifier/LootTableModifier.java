...
public class LootTableModifier {
    ...
    public static void init(LootTableLoadEvent event) {
        ...
        modifyBlockLoot(ItemRegistry.DIAMOND_NUGGET.get(), ConstantConfig.DIAMOND_NUGGET_FROM_DIAMOND.get().floatValue(), 2f, "diamond_ore", "deepslate_diamond_ore");
        modifyBlockLoot(ItemRegistry.DIAMOND_NUGGET.get(), ConstantConfig.DIAMOND_NUGGET_FROM_COAL.get().floatValue(), 1f, "coal_ore", "deepslate_coal_ore");
