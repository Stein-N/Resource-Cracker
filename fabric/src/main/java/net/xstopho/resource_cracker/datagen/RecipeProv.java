...
public class RecipeProv extends FabricRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput exporter) {
        ...
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_CARBON.get(), Items.CHARCOAL, 2, FabricItemTags.CRACK_HAMMER);
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_COPPER.get(), Items.RAW_COPPER, 2, FabricItemTags.CRACK_HAMMER);
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_IRON.get(), Items.RAW_IRON, 2, FabricItemTags.CRACK_HAMMER);
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_GOLD.get(), Items.RAW_GOLD, 2, FabricItemTags.CRACK_HAMMER);

        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_COPPER.get(), Items.COPPER_INGOT, 1, FabricItemTags.CRACK_HAMMER);
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_IRON.get(), Items.IRON_INGOT, 1, FabricItemTags.CRACK_HAMMER);
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_GOLD.get(), Items.GOLD_INGOT, 1, FabricItemTags.CRACK_HAMMER);
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_STEEL.get(), ItemRegistry.STEEL_INGOT.get(), 1, FabricItemTags.CRACK_HAMMER);
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_DIAMOND.get(), Items.DIAMOND, 1, FabricItemTags.CRACK_HAMMER);
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_NETHERITE.get(), Items.NETHERITE_INGOT, 1, FabricItemTags.CRACK_HAMMER);
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_EMERALD.get(), Items.EMERALD, 1, FabricItemTags.CRACK_HAMMER);

        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_DIAMOND.get(), Items.DIAMOND_ORE, 2, FabricItemTags.CRACK_HAMMER);
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_DIAMOND.get(), Items.DEEPSLATE_DIAMOND_ORE, 2, FabricItemTags.CRACK_HAMMER);
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_EMERALD.get(), Items.EMERALD_ORE, 2, FabricItemTags.CRACK_HAMMER);
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_EMERALD.get(), Items.DEEPSLATE_EMERALD_ORE, 2, FabricItemTags.CRACK_HAMMER);
        Recipes.materialDustRecipe(exporter, ItemRegistry.MATERIAL_DUST_NETHERITE_SCRAP.get(), Items.ANCIENT_DEBRIS, 2, FabricItemTags.CRACK_HAMMER);
